...
class TupleOfMoviesEntityTest {
    ...
    void validConstructor() {
        ...
        final var entity = new TupleOfMoviesEntity(id, movieOne, movieTwo);
    ...
    void validateEquals(final TupleOfMoviesEntity tupleOne, final TupleOfMoviesEntity tupleTwo, final boolean expectedResult) {
        //GIVEN WHEN
    ...
    private static Stream<Arguments> equalSamples() {
        ...
        final var tupleOfMoviesOne = new TupleOfMoviesEntity(1L, movieA, movieB);
        final var tupleOfMoviesTwo = new TupleOfMoviesEntity(2L, movieB, movieA);
        final var tupleOfMoviesThree = new TupleOfMoviesEntity(3L, movieA, movieC);
